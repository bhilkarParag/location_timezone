 ...
 */
class LocationTimezoneConfigForm extends ConfigFormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'location_timezone_settings_form';
  }
  ...
  protected function getEditableConfigNames() {
    return ['location_timezone.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    // Get default values.
    $config = $this->config('location_timezone.settings');
